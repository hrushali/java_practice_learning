...
double salesbyteam;
public salesManager(String firstname, String lastname, int registration, int age, int dayworked, int vacationDaystaken,
double salary, int yearsWorked, double salesMade, double salesbyteam) {
super(firstname, lastname, registration, age, dayworked, vacationDaystaken, salary, yearsWorked, salesMade);
